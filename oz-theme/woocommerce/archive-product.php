 ...
 * Two-column layout: category sidebar on left, product grid on right.
...
<div class="oz-shop oz-container">
    ...
    <div class="oz-shop__layout">
        ...
        <aside class="oz-shop__sidebar" id="shop-sidebar">
            ...
            <?php
            /* Price filter — uses WooCommerce's native price filter widget */
            ...
            <?php if ( woocommerce_product_loop() ) : ?>
                ...
                <div class="oz-shop__toolbar">
                    <button class="oz-shop__filter-toggle oz-btn oz-btn--outline oz-btn--sm" id="filter-toggle" type="button">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="4" y1="6" x2="20" y2="6"/><line x1="8" y1="12" x2="20" y2="12"/><line x1="12" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="0"/><circle cx="8" cy="12" r="0"/><circle cx="12" cy="18" r="0"/></svg>
                        Filter
                    </button>
