...
function push(eventName, params) {
  ...
  // Tag every PDP analytics event with the A/B/C variant so conversion can
  // be split per variant in oz_analytics_events. Cookie set by inline
  // script in oz-theme functions.php.
  var abTools = '';
  try {
