...
class OZ_Ajax_Handlers {
    ...
    public static function ajax_add_to_cart() {
        ...
        // Different addon configs (e.g. RAL 7044 vs RAL 1004) produce different
        // cart_keys via WC's generate_cart_id hash of cart_item_data — that means
        // a customer buying two colors of the same base product ends up with two
        // distinct lines, which is the correct behavior. Do NOT add a "stale line"
        // cleanup pass here: previously such a pass silently deleted the first
        // colour when a second was added, turning a 2-colour order into a 1-colour
        // order with no notice to the customer.
