...
return array(
	...
	'fields' => array(
		...
		'productlijn' => array(
			...
			'type'        => 'autocomplete',
			'required'    => true,
			'placeholder' => 'Zoek of kies een productlijn…',
			'options'     => array(
				'original'        => 'Beton Ciré Original',
				'easyline'        => 'Beton Ciré Easyline',
				'all-in-one'      => 'Beton Ciré All-In-One',
				'microcement'     => 'Microcement Performance',
				'lavasteen'       => 'Lavasteen Gietvloer (epoxystone)',
				'metallic-velvet' => 'Metallic Stuc Velvet',
				'betonstuc'       => 'Betonstuc',
				'betonlook-verf'  => 'Betonlook verf',
				'croco-stuc'      => 'Croco Stuc',
				'pu-color'        => 'Pu Color Coating',
